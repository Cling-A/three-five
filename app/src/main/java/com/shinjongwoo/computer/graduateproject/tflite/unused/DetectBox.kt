package com.shinjongwoo.computer.graduateproject.tflite.unused
...
class DetectBox(var name: String?,
    ...
    val green = ContextCompat.getDrawable(context, R.drawable.green_border)
    val red = ContextCompat.getDrawable(context, R.drawable.green_border)
    init {
        text.text = name
